...
При работе с арифметичекими опеарциями с числами с плавающей точкой необходимо помнить про такие вещи как: мантисса, порядок числа, округление, сдвиг, машинная ошибка и т.д  
